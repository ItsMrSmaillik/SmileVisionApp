                ...
                {news.length === 0 ? (
                  ...
                  news.map((post) => (
                    <motion.div
                      key={post.id}
                      layout
                      className="glass rounded-2xl p-5 relative cursor-pointer hover:bg-white/10 transition-all duration-300 group"
                    ...
                    >
                      ...
                      <div className="text-lg leading-relaxed markdown-body line-clamp-3 overflow-hidden opacity-80">
                        <ReactMarkdown 
                      ...
                      {isAdmin && (
                        <button 
                          ...
                          className="absolute top-2 right-2 p-2 bg-red-500/20 hover:bg-red-500/40 rounded-full transition-colors z-10"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      )}
