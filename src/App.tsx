...
export default function App() {
  ...
  return (
    <AnimatePresence mode="wait">
      {(!isAuthReady || isAppLoading) ? (
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            ...
            />
            <motion.div 
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-red-500/10 rounded-full blur-[120px]"
              animate={{ 
                rotate: [0, 360],
              }}
        ...
        <motion.div 
          ...
          className={`min-h-screen transition-colors duration-700 overflow-hidden relative font-sans bg-cover bg-center bg-fixed`}
      ...
      <div className={`absolute inset-0 bg-gradient-to-br ${currentThemeObj.bg} opacity-40 mix-blend-overlay pointer-events-none transition-colors duration-700`}></div>
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-white/10 blur-3xl mix-blend-overlay"></div>
      </div>
      ...
      <div className="relative z-10 max-w-md mx-auto min-h-screen flex flex-col p-6">
        ...
        <header className="text-center mb-8 mt-4">
          ...
          <motion.h2 
            className="font-display text-4xl mt-6 text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.8)]"
          ...
          {appState.winnerPost && (
            ...
            >
              <motion.div 
                ...
                className="glass rounded-[3rem] p-8 text-center relative overflow-hidden group shadow-[0_0_50px_rgba(253,224,71,0.4)] border-yellow-300/50"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-300/30 via-white/10 to-yellow-500/30 animate-[shimmer_3s_infinite] -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"></div>
                ...
                >
                  <Crown className="w-20 h-20 mx-auto text-yellow-300 mb-4 drop-shadow-[0_0_15px_rgba(253,224,71,0.8)]" />
                </motion.div>
        ...
        <div className="flex gap-2 mb-6 p-1 glass rounded-2xl">
          <button
            ...
            className={`flex-1 py-3 px-4 rounded-xl font-display text-xl transition-all ${
